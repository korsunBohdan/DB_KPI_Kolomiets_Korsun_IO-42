...
* [Посилання на OLTP_SQL інструкції](Lab_3/Lab_3.sql)
...
```
![Всі доступні категорії](Lab_3/img/all_avaliable_category.png)
```sql
-- Отримання всіх товарів конкретної категорії (наприклад, Вибухонебезпечне)
SELECT * FROM products
WHERE category_id = 4;
```
![Всі товари конкретної категорії](Lab_3/img/product_by_category.png)
```sql
-- Перегляд усіх складів
SELECT * FROM warehouse;
```
![Склади](Lab_3/img/warehouse.png)
```sql
-- Перегляд усіх клієнтів
SELECT * FROM clients;
```
![Клієнти](Lab_3/img/clients.png)
